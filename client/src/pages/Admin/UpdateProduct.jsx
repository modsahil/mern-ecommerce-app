...
const UpdateProduct = () => {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            console.log(error)
            alert('Something Went Wrong in Submit')
        }
    }


    //Hamdle Delete Button
                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        ...
                        <div className="m-1 w-75">
                            ...
                            <div className="mb-3">
                                <input type="text" value={name} placeholder='Update a Product Name' className='form-control' onChange={(e) => setName(e.target.value)} />
                            </div>
                            {/* <div className="mb-3">
                                <input type="text" value={category} placeholder='Update a Category Name' className='form-control' onChange={(e) => setCategory(e.target.value)} />
                            </div> */}
                            <div className="mb-3">
                                <input type="text" value={price} placeholder='Update Price' className='form-control' onChange={(e) => setPrice(e.target.value)} />
                            </div>
                            <div className="mb-3">
                                <input type="text" value={description} placeholder='Update a Description' className='form-control' onChange={(e) => setDescription(e.target.value)} />
                            </div>
                            <div className="mb-3">
                                <input type="number" value={quantity} placeholder='Update quantity' className='form-control' onChange={(e) => setQuantity(e.target.value)} />
                            </div>
                            <div className="mb-3">
                                <Select bordered={false} placeholder='Update Shipping' size='large' showSearch className='form-select mb-3' onChange={(value) => setShipping(value)} value={shipping ? 'Yes' : 'No'}>
